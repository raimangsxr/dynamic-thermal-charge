...
KNOWN_REVISIONS: tuple[str, ...] = (
    ...
    "0007_thermal_loss",
    "0008_automatic_charge_planning",
    "0009_remove_state_file",
    "0010_mqtt_planning_simulation",
    "0011_planning_base_load",
    "0012_preview_jobs",
    "0013_configurable_solver_time_limit",
    "0014_room_energy_model",
    "0015_temperature_target_intervals",
    "0016_home_assistant_control",
    "0017_group_mqtt_telemetry",
    "0018_soc_dependent_emission",
    "0019_discharge_setpoint_topic",
    "0020_email_alerts",
