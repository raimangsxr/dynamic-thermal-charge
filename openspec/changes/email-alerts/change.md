...
- [ ] T1: Añadir la sección de correo a la configuración de sistema y sus dos secretos al catálogo, con su validación.
- [ ] T2: Añadir la tabla de cola de alertas y la de catálogo con su estado de rearme, con migración Alembic y esquema.
- [ ] T3: Añadir un módulo de alertas con el encolado, la deduplicación por episodio y el envío SMTP con reintentos y espera creciente.
- [ ] T4: Conectar el paso de envío al ciclo de control, tolerando cualquier fallo de correo sin afectar al accionamiento.
- [ ] T5: Emitir la alerta de R8 en el recálculo periódico `INVALID` que deja la instalación sin plan activo.
- [ ] T6: Exponer en la API la sección de correo, la rotación de secretos, la activación por tipo y el envío de prueba.
- [ ] T7: Editar todo lo anterior en el panel, con sus tipos, su texto de ayuda y sus pruebas.
- [ ] T8: Cubrir con tests la configuración y sus secretos, el encolado, la deduplicación por episodio, los reintentos y el agotamiento, la tolerancia a fallos y el envío de prueba.
- [ ] T9: Actualizar `openspec/specs/planning/spec.md` si procede y las secciones de configuración y operación de `README.md`.
- [ ] T10: Ejecutar `make check`.
