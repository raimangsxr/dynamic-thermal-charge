...
- [x] T1: Reestructurar el shell para header y sidenav fijos, con botón de toggle en escritorio y móvil.
- [x] T2: Reorganizar Planificación en cards resumen, cards de gráficos y diálogos de detalle.
- [x] T3: Corregir ciclo de render y configuración de datasets, etiquetas, tooltips y fechas.
- [x] T4: Ampliar las pruebas unitarias y ejecutar la calidad del proyecto.
